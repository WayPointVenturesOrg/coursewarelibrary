...
12. On the taskbar, select **Start**, enter **gpedit.msc**, and then press Enter.
...
14. In the **Lanman Server** pane, in the **Setting** list, right-click **Hash Publication for BranchCache**, and then select **Edit**.
...
4. Enter **Share**, and then press Enter.

5. Right-click **Share**, and then select **Properties**.
...
11. On the taskbar, select **Start**, enter **cmd**, and then press Enter.
...
3. In **Group Policy Management**, expand **Forest: Contoso.com**, expand **Domains**, expand **Contoso.com**, right-click **Default Domain Policy**, and then select **Edit**.
...
2. In the **Windows PowerShell** window, enter the following cmdlet, and then press Enter:

   ```
   Enable-BCHostedServer –RegisterSCP
   ```

3. In the **Windows PowerShell** window, enter the following cmdlet, and then press Enter:
...
4. Right-click **LON-CL1**, and then select **Move**.
...
10. In the **Group Policy Management** console, in the navigation pane, expand **Forest: Contoso.com**, expand **Domains**, expand **Contoso.com**, right-click **IT**, and then select **Create a GPO in this domain and link it here**.

11. In the **New GPO** window, enter **BCClient**, and then select **OK**.

12. In the **Group Policy Management** console, in the navigation pane, expand **Forest: Contoso.com**, expand **Domains**, expand **Contoso.com**, expand **IT**, right-click **BCClient**, and then select **Edit**.
...
14. In the **BranchCache** results pane, in the **Setting** list, right-click **Turn on BranchCache**, and then select **Edit**.

15. In the **Turn on BranchCache** dialog box, select **Enabled**, and then select **OK**.

16. In the **BranchCache** results pane, in the **Setting** list, right-click **Enable Automatic Hosted Cache Discovery by Service Connection Point**, and then select **Edit**.
...
18. In the **BranchCache** results pane, in the **Setting** list, right-click **Configure** **BranchCache for network files**, and then select **Edit**.
...
20. Close the **Group Policy Management Editor** and close the **Group Policy Management** console.

21. Restart **LON-CL1**, and sign in as **Contoso\Administrator** with the password **Pa55w.rd**.

22. On the taskbar, select **Start**, enter **cmd**, and then press Enter.

23. In the **Command Prompt** window, enter the following command, and then press Enter:

    ```
    gpupdate /force
    ```

24. At the command prompt, enter the following command, and then press Enter: 
...
26. Select **Start**, and then enter **cmd.exe**. Press Enter.

27. In the **Command Prompt** window, enter the following command, and then press Enter:

    ```
    gpupdate /force
    ```

28. In the **Command Prompt** window, enter the following command, and then press Enter: 
...
You need to verify that the BranchCache configuration you implemented for the Toronto and Sydney locations are functioning properly.
...
1. On **SYD-SVR1**, select **Start**, enter **gpedit.msc**, and then press Enter. 

2. In the navigation pane of the **Local Group Policy Editor** console, under **Computer** **Configuration**, expand **Windows Settings**, right-click **Policy-based QoS**, and then select **Create new policy**.
...
2. Select Start, enter **perfmon**, and then press Enter.
...
11. In **File Explorer**, in the address bar, enter **\\\\SYD-SVR1\\Share**, and then press Enter.

12. In **File Explorer**, right-click **mspaint.exe**, and then select **Copy**.

13. In **File Explorer**, right-click **Desktop**, and then select **Paste**.

    > **Note:** This file copy will take some time because of the 100-Kbps bandwidth limit placed on **SYD-SVR1**.

14. In **Performance Monitor**, select any counter, and then press Ctrl+A.

15. Right-click any counter, and then select **Scale Selected Counters**.
...
19. In the **Windows PowerShell** window, enter the following command, and then press Enter:
...
22. In **File Explorer**, in the address bar, enter **\\\\SYD-SVR1\\Share**, and then press Enter.

23. In **File Explorer**, right-click **mspaint.exe**, and then select **Copy**.

24. In **File Explorer**, right-select **Desktop**, and then select **Paste**.

    > **Note:** Note that the file copy time is much faster than to LON-CL1, because the file is cached on **LON-SVR1**.

**Results:** Upon completion of this exercise, you will have validated BranchCache.