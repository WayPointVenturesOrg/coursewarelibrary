...
4. At the command prompt, enter the following command, where `<version>` is the number that you recorded in the previous step, and then select Enter:
...
5. Enter **`Y`**, and then select Enter. 

6. Enter **`Y`**, and then select Enter.

   > **Note:** The restoration will take about 45 minutes. 

7. When prompted to restart, enter **`Y`**, and then select Enter.
...
9. Enter **quit**, and then select Enter. 
